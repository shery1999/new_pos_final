                                ...
                                <div class="tab-content border border-top-0 p-3" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form class="" action="/add_items" method="post" {{-- onsubmit="this.submit();  --}}
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input class="form-control mb-4 mb-md-0" name="item_Price"
                                                                type="text"
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input class="form-control mb-4 mb-md-0" name="item_Weight"
                                                                type="text"
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input class="form-control mb-4 mb-md-0" name="item_Quantity"
                                                                type="text"

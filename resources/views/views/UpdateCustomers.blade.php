                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12 border-end-lg">
                            ...
                            <h4 id="default">Update Customers</h4>
                            <div class="example">
                                ...
                                <div class="tab-content border border-top-0 p-3" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel"
                                        ...
                                        <h6 class="mb-1">Update Customers</h6>
                                        <div class="card-body">

                                            <form class="" action="/update_customer/{{ $Data[0]['id'] }}"
                                                enctype="multipart/form-data" method="post" {{-- onsubmit="this.submit();  --}}
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <textarea id="maxlength-textarea" class="form-control" id="customer_address" name="customer_address" maxlength="100"
                                                            rows="8" placeholder="Enter address">{{ $Data[0]['address'] }}</textarea>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <textarea id="maxlength-textarea" class="form-control" id="defaultconfig-4" maxlength="100" name="customer_description"
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="card-body">
                                                            ...
                                                            <input name="cnic_image" type="file" id="myDropify" />
